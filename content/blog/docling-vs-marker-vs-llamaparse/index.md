...
author: Khuyen Tran
authorAvatar: https://openteams.com/wp-content/uploads/2024/11/Khuyen-Tran.png
summary: 'Compare three Python tools for PDF table extraction: Docling, Marker, and
  LlamaParse. Learn which handles merged cells and multi-level headers best.'
description: 'Compare three Python tools for PDF table extraction: Docling, Marker,
  and LlamaParse. Learn which handles merged cells and multi-level headers best.'
tags:
- Engineering
image: cover.svg
---
