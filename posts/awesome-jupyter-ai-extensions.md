...
| Completion as you type | [jupyter-copilot](https://github.com/baolong281/jupyter-copilot) for GitHub Copilot, or [jupyterlab-browser-ai](https://github.com/jtpio/jupyterlab-browser-ai), which needs no API key |
