---
title: "Social Brief Test Post 2"
slug: social-brief-test-2
authors:
  - khuyen-tran
categories:
  - Engineering
...
When a pull request adds a post, CI should commit an empty `social/social-brief-test-2.yml` to the branch and fail the `social-brief` check until every answer is filled in.
